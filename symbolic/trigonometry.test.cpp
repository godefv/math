...
int main(){
	...
	check_equal(sin(ratio<1,3>*half_turn), vector::basis_vector_t{sqrt(integer<3>), ratio<1,2>});
	...
	check_equal(vector::basis_vector_t{square(cos(x)), integer<5>}+vector::basis_vector_t{square(sin(x)), integer<5>}, integer<5>);
	...
	check_equal(vector::basis_vector_t{square(cosh(x)), integer<5>}-vector::basis_vector_t{square(sinh(x)), integer<5>}, integer<5>);
