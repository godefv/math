...
using e1_t=vector::basis_element_t<vector::direction_t<1>>;
using e2_t=vector::basis_element_t<vector::direction_t<2>>;
using e3_t=vector::basis_element_t<vector::direction_t<3>>;
