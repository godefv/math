...
namespace group{
	...
	template<template<class,class> class BinaryOperator, class A,class B,class C> struct operation_t<BinaryOperator, A,generated_element_t<BinaryOperator,B,C>>: BinaryOperator<typename BinaryOperator<A,B>::type,C>{};
